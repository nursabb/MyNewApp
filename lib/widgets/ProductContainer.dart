...
import 'package:project/screens/SingleProduct.dart';
...
class ProductContainer extends StatelessWidget {
  ...
  ProductContainer({required this.title, required this.imageUrl, required this.price});
